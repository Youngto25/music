...
class Player {
  ...
  start() {
    fetch('https://youngto25.github.io/data-mock/music/music-list.json')
      .then(res => res.json())
      .then(data => {
        console.log(data);
        this.songList = data;
  ...
  bind() {
    ...
    this.$('.btn-pre').addEventListener('click', () => {
