...
},{}],"src/js/swiper.js":[function(require,module,exports) {
"use strict";
...
function () {
  ...
  _createClass(Player, [{
    ...
    value: function start() {
      ...
      fetch('https://youngto25.github.io/data-mock/music/music-list.json').then(function (res) {
        return res.json();
      }).then(function (data) {
        console.log(data);
    ...
    value: function bind() {
      ...
      this.$('.btn-pre').addEventListener('click', function () {
        _this3.currentIndex = (_this3.songList.length + _this3.currentIndex - 1) % _this3.songList.length;

        _this3.loadSong();

        _this3.playSong();
      });
      this.$('.btn-next').addEventListener('click', function () {
        _this3.currentIndex = (_this3.songList.length + _this3.currentIndex + 1) % _this3.songList.length;
      ...
      var swiper = new _swiper.default(this.$('.area-effect'));
      var balls = document.querySelectorAll('.balls>span');
...
new Player('#player');
},{"./icons.js":"src/js/icons.js","./swiper.js":"src/js/swiper.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
